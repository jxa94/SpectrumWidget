...
- 收起成小圆片：鼠标移到卡片上右上角会出现收起按钮，或者按全局快捷键 **Ctrl+Alt+M**。收起后屏幕上留一个小圆片（转动的黑胶封面 + 迷你频谱），单击展开，也可以拖动；收起 / 展开时贴着靠近屏幕角落的那一角
- 自动收起 / 隐藏（可选）：没在播放时收起成小圆片、开始播放时自动展开；有全屏程序（游戏、全屏视频）时完全隐藏。只有全屏和托盘单击是直接消失
- 托盘图标：左键显示 / 隐藏，右键打开菜单
